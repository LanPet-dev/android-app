...
interface FreeBoardApiService {
    ...
    suspend fun updateFreeBoardComment(
        ...
        @Body
        content: String,
    ): FreeBoardModifyCommentResponse
    ...
    @GET("$PATH/{sarangbangId}/comments/{commentId}")

...
fun DeleteProfileDialog(
    ...
    BaseDialog(
        content = {
            Text(
                stringResource(R.string.dialog_delete_profile_content),
                style =
        ...
        dismiss = {
            TextButton(
                ...
                Text(
                    stringResource(R.string.dialog_delete_profile_dismiss),
                    style =
        ...
        confirm = {
            TextButton(
                ...
                Text(
                    stringResource(R.string.dialog_delete_profile_confirm),
                    style =
                        MaterialTheme.customTypography().body1SemiBoldSingle.copy(

...
public val MyIconPack.ContentsFill: ImageVector
    get() {
        if (_contentsFill != null) {
            return _contentsFill!!
        }
        _contentsFill = Builder(name = "ContentsFill", defaultWidth = 24.0.dp, defaultHeight =
...
private var _contentsFill: ImageVector? = null

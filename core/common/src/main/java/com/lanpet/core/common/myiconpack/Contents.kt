...
public val MyIconPack.Contents: ImageVector
    get() {
        if (_contents != null) {
            return _contents!!
        }
        _contents = Builder(name = "Contents", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _contents: ImageVector? = null

...
public val MyIconPack.HeartFill: ImageVector
    get() {
        if (heartFill != null) {
            return heartFill!!
        }
        heartFill =
            Builder(
                ...
                path(
                    ...
                    curveTo(21.351f, 11.8792f, 21.7563f, 11.2728f, 22.0329f, 10.6054f)
...
private var heartFill: ImageVector? = null
